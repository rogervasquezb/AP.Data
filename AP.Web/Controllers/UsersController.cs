...
namespace AP.Web.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(ApdatadbContext context, IUserRepository userRepository)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("UserId,Username,Password,Email,CreatedAt")] User user)
        {
